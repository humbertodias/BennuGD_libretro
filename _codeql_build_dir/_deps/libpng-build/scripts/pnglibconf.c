 ...
 *   requires:  
 *   if:        
 *   enabled-by: READ_RGB_TO_GRAY READ_cHRM WRITE_cHRM READ_cICP WRITE_cICP READ_iCCP WRITE_iCCP READ_sRGB WRITE_sRGB
 *   sets:       */
#undef PNG_on
#define PNG_on 1
#undef PNG_no_if
 ...
 *   requires:  
 *   if:        
 *   enabled-by: COLORSPACE READ_cICP WRITE_cICP READ_gAMA WRITE_gAMA READ_iCCP WRITE_iCCP READ_sRGB WRITE_sRGB
 *   sets:       */
#undef PNG_on
#define PNG_on 1
#undef PNG_no_if
